...
### Bug 修复 + 功能改造（V0.4.2）
- [ ] Bug: Prompt 模板选择器点击无效（深入排查事件拦截根因）
- [ ] 重新设计合并分段：移除分段预览页的整体合并触发
- [ ] 重新设计合并分段：merged_chunks 表增加 topicId 关联
- [ ] 重新设计合并分段：话题详情页增加"合并相关分段"按钮
- [ ] 重新设计合并分段：按话题合并 LLM API
- [ ] 重新设计合并分段：话题详情页展示合并后内容
- [ ] 重新设计合并分段：分段预览页合并 tab 按话题分组展示
