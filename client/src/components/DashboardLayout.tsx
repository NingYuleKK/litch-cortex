...
import { Upload, FileText, Tags, Brain, LogOut, PanelLeft } from "lucide-react";
...
const menuItems = [
  { icon: Upload, label: "上传文档", path: "/" },
  { icon: FileText, label: "分段预览", path: "/chunks" },
  { icon: Tags, label: "话题列表", path: "/topics" },
];
